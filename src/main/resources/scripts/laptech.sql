...
INSERT INTO `tbl_address` (`id`, `user_id`, `country`, `line1`, `line2`, `line3`, `street`, `is_default`,
                           `created_date`, `modified_date`, `deleted_date`, `is_del`, `update_by`)
VALUES ('1', 1, 'Việt Nam', 'tỉnh An Giang', 'Thị xã Tân Châu', 'phường Long Hưng',
        'số 1 đường Lạc Long Quân, khóm Long Thạnh C', 1, '2023-02-11 00:00:00', '2023-02-11 00:00:00', NULL, 0,
        'system'),
       ('2', 2, 'Việt Nam', 'Việt Nam', 'Thành phố Thủ Đức', 'phường Linh Trung', '64/1L, đường số 17', 1,
        '2023-02-11 00:00:00', '2023-02-11 00:00:00', NULL, 0, 'system'),
       ('3', 3, 'Việt Nam', 'Việt Nam', 'Thành phố Thủ Đức', 'phường Linh Trung', '64/1L, đường số 17', 1,
        '2023-02-11 00:00:00', '2023-02-11 00:00:00', NULL, 0, 'system');
...
DELIMITER $$
CREATE TRIGGER `after_address_delete`
    AFTER DELETE
    ON `tbl_address`
    FOR EACH ROW
BEGIN
...
INSERT INTO `tbl_banner` (`id`, `path`, `type`, `title`, `link_product`, `used_date`, `ended_date`, `created_date`,
                          `modified_date`, `deleted_date`, `is_del`, `update_by`)
VALUES (0, 'bbb', 'aaa', 'aaa', NULL, '2023-02-09', '2023-02-10', '2023-02-09 19:31:47', '2023-02-09 20:33:53', NULL, 0,
        'system'),
       (1, 'bbb', 'aaa', 'aaa', NULL, '2023-02-09', '2023-02-10', '2023-02-09 19:31:47', '2023-02-09 20:33:53', NULL, 0,
        'system'),
       (2, 'https://i.pinimg.com/originals/81/0b/4c/810b4ccbb372f6585b370d3f623ab55a.jpg', 'advertise', 'laptop', 'aaa',
        '2023-02-09', '2023-02-09', '2023-02-09 19:31:47', '2023-02-09 19:31:47', NULL, 0, 'system'),
       (3, 'https://www.infobahnindia.net/wp-content/uploads/2018/10/HP-Business-Notebooks-Banner.jpg', 'advertise',
        'laptop', 'aaa', '2023-02-09', '2023-02-09', '2023-02-09 19:31:47', '2023-02-09 19:31:47', NULL, 0, 'system'),
       (4, 'https://www.infobahnindia.net/wp-content/uploads/2018/10/Hp-mobile-Workstation-banner.jpg', 'advertise',
        'laptop', 'aaa', '2023-02-09', '2023-02-09', '2023-02-09 19:31:47', '2023-02-09 19:31:47', NULL, 0, 'system'),
       (5,
        'https://images.fpt.shop/unsafe/fit-in/1200x300/filters:quality(90):fill(white)/fptshop.com.vn/Uploads/Originals/2021/3/31/637528312299597503_F-C1_1200x300.png',
        'advertise', 'laptop', 'aaa', '2023-02-09', '2023-02-09', '2023-02-09 19:31:47', '2023-02-09 19:31:47', NULL, 0,
        'system'),
       (6, 'https://digitalterminal.in/images/Acer_Diwali_Web_banner_2_for_DT-1200x300_px.jpg', 'advertise', 'laptop',
        'aaa', '2023-02-09', '2023-02-09', '2023-02-09 19:31:47', '2023-02-09 19:31:47', NULL, 0, 'system'),
       (7, 'https://fptshop.com.vn/Uploads/Originals/2020/7/7/637297265802454422_C1.png', 'advertise', 'laptop', 'aaa',
        '2023-02-09', '2023-02-09', '2023-02-09 19:31:47', '2023-02-09 19:31:47', NULL, 0, 'system');
...
DELIMITER $$
CREATE TRIGGER `after_banner_update`
    AFTER UPDATE
    ON `tbl_banner`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `before_banner_update`
    BEFORE UPDATE
    ON `tbl_banner`
    FOR EACH ROW
BEGIN
...
INSERT INTO `tbl_brand` (`id`, `name`, `country`, `establish_date`, `logo`, `created_date`, `modified_date`,
                         `deleted_date`, `is_del`, `update_by`)
VALUES (0, 'Logitech', 'Switzerland', '1981-02-10',
        'http://localhost:8088/api/v1/files/2793341afd484cb491f7e395315e75b0.png', '2023-02-12 23:01:58',
        '2023-02-23 21:27:54', '2023-02-23 21:27:54', 1, 'system'),
       (2, 'DELL', 'US', '1984-02-01', 'http://localhost:8088/api/v1/files/769fddd0ce904b38954d6771be397dae.png',
        '2023-02-12 23:03:24', '2023-02-18 01:15:11', NULL, 0, 'system'),
       (3, 'ASUS', 'Taiwan', '1989-04-02', 'http://localhost:8088/api/v1/files/95f6a56bfbd345678f1c7102ac06507c.png',
        '2023-02-18 01:27:39', '2023-02-18 01:31:25', NULL, 0, 'system'),
       (4, 'ACER', 'Taiwan', '1976-04-01', 'http://localhost:8088/api/v1/files/d1945e27e0a34161ae13bced3d777957.png',
        '2023-02-18 01:38:54', '2023-02-18 22:54:43', NULL, 0, 'system'),
       (6, 'Gigabyte', 'Taiwan', '1986-01-01',
        'http://localhost:8088/api/v1/files/f22a2eb5ed5442bea57a399e7f1f23e5.png', '2023-02-18 01:49:12',
        '2023-02-18 23:51:53', NULL, 0, 'system'),
       (7, 'Logitech', 'Hong Kong', '1986-11-01',
        'http://localhost:8088/api/v1/files/43c22942399f44949c75da84fa6c03ec.png', '2023-02-18 23:26:51',
        '2023-02-18 23:29:37', NULL, 0, 'system'),
       (8, 'HP', 'USA', '1939-07-02', 'http://localhost:8088/api/v1/files/459fdee58332438aaf1fa90f4eda5840.png',
        '2023-02-18 23:43:25', '2023-02-19 00:29:30', NULL, 0, 'system'),
       (9, 'MSI', 'Taiwan', '1986-08-04', 'http://localhost:8088/api/v1/files/df7058ed79cc47528ed1378fb3a9d770.png',
        '2023-02-18 23:49:57', '2023-02-18 23:49:57', NULL, 0, 'system'),
       (10, 'Apple', 'USA', '1976-04-01', 'http://localhost:8088/api/v1/files/ec6a85d77b7d400cac3ac945dbe22e9e.png',
        '2023-02-18 23:55:52', '2023-02-18 23:55:52', NULL, 0, 'system'),
       (12, 'Microsoft', 'USA', '1975-04-04', 'http://localhost:8088/api/v1/files/22020ae7578c4641a917a0a492d1f8c2.png',
        '2023-02-19 00:01:10', '2023-02-19 00:01:10', NULL, 0, 'system'),
       (13, 'Google', 'US', '1998-04-09', 'http://localhost:8088/api/v1/files/c7d6a85274b64d05b31638e4519d2bfe.png',
        '2023-02-19 00:03:14', '2023-02-19 00:03:14', NULL, 0, 'system'),
       (14, 'Samsung', 'Korea', '1938-03-01', 'http://localhost:8088/api/v1/files/eeb087efba7549d398820ec0ef7f3419.png',
        '2023-02-19 00:07:11', '2023-02-19 00:07:11', NULL, 0, 'system'),
       (15, 'Toshiba', 'Japan', '1875-11-07', 'http://localhost:8088/api/v1/files/ce47d4f6e3444e45b6ff9287e7b06a66.png',
        '2023-02-19 00:10:44', '2023-02-19 00:10:44', NULL, 0, 'system');
...
DELIMITER $$
CREATE TRIGGER `after_brand_update`
    AFTER UPDATE
    ON `tbl_brand`
    FOR EACH ROW
BEGIN
...
INSERT INTO `tbl_category` (`id`, `name`, `image`, `description`, `created_date`, `modified_date`, `deleted_date`,
                            `is_del`, `update_by`)
VALUES (1, 'Laptop', 'http://localhost:8088/api/v1/files/4599305e04cf4632baaa7fd01dc22802.png',
        'Thiết bị dùng hằng ngày của con dân công nghệ bên cạnh cục gạch', '2023-02-19 01:01:02', '2023-02-19 01:10:21',
        NULL, 0, 'system'),
       (2, 'Screen', 'http://localhost:8088/api/v1/files/d41436e8c40548d9af05e6e321b0e7cb.jpg',
        'Màn hình máy tính dùng cực chill~!', '2023-02-19 01:14:26', '2023-02-19 01:18:02', NULL, 0, 'system');
...
INSERT INTO `tbl_discount` (`id`, `code`, `rate`, `applied_type`, `max_amount`, `applied_date`, `ended_date`,
                            `created_date`, `modified_date`, `deleted_date`, `is_del`, `update_by`)
VALUES (1, 'BANOIDUNGNGAI', 0.08, 'PRODUCT', '120000.0000', '2023-02-18 07:30:00', '2023-02-28 22:00:00',
        '2023-02-19 01:30:58', '2023-02-19 01:30:58', NULL, 0, 'system');
...
DELIMITER $$
CREATE TRIGGER `after_discount_delete`
    AFTER DELETE
    ON `tbl_discount`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_discount_update`
    AFTER UPDATE
    ON `tbl_discount`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_import_delete`
    AFTER DELETE
    ON `tbl_import`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_import_update`
    AFTER UPDATE
    ON `tbl_import`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `before_import_update`
    BEFORE UPDATE
    ON `tbl_import`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_label_delete`
    AFTER DELETE
    ON `tbl_label`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_label_update`
    AFTER UPDATE
    ON `tbl_label`
    FOR EACH ROW
BEGIN
...
INSERT INTO `tbl_log_system` (`id`, `action_table`, `record_id`, `action_time`, `action_by`, `action_name`)
VALUES (1, 'tbl_brand', '1', '2023-02-23 21:25:46', 'system', 'UPDATE'),
...
DELIMITER $$
CREATE TRIGGER `after_product_accessory_delete`
    AFTER DELETE
    ON `tbl_product_accessory`
    FOR EACH ROW
BEGIN
    INSERT INTO tbl_log_system(action_table, record_id, action_name, action_time, action_by)
...
DELIMITER $$
CREATE TRIGGER `after_product_accessory_insert`
    AFTER INSERT
    ON `tbl_product_accessory`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_product_discount_delete`
    AFTER DELETE
    ON `tbl_product_discount`
    FOR EACH ROW
BEGIN
    INSERT INTO tbl_log_system(action_table, record_id, action_name, action_time, action_by)
...
DELIMITER $$
CREATE TRIGGER `after_product_discount_insert`
    AFTER INSERT
    ON `tbl_product_discount`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `before_product_image_update`
    BEFORE UPDATE
    ON `tbl_product_image`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_product_label_delete`
    AFTER DELETE
    ON `tbl_product_label`
    FOR EACH ROW
BEGIN
    INSERT INTO tbl_log_system(action_table, record_id, action_name, action_time, action_by)
...
DELIMITER $$
CREATE TRIGGER `after_product_label_insert`
    AFTER INSERT
    ON `tbl_product_label`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_product_unit_delete`
    AFTER DELETE
    ON `tbl_product_unit`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_product_unit_insert`
    AFTER INSERT
    ON `tbl_product_unit`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `after_product_unit_update`
    AFTER UPDATE
    ON `tbl_product_unit`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `before_product_unit_update`
    BEFORE UPDATE
    ON `tbl_product_unit`
    FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE TRIGGER `tbl_refresh_token_BEFORE_INSERT`
    BEFORE INSERT
    ON `tbl_refresh_token`
    FOR EACH ROW
BEGIN
...
INSERT INTO `tbl_role` (`id`, `name`, `description`, `created_date`, `modified_date`, `deleted_date`, `is_del`,
                        `update_by`)
VALUES (1, 'ADMIN', 'Administrator', '2023-02-20 21:29:15', '2023-02-20 21:29:15', NULL, 0, 'system'),
...
INSERT INTO `tbl_user` (`id`, `name`, `gender`, `date_of_birth`, `phone`, `email`, `password`, `is_active`,
                        `created_date`, `modified_date`, `deleted_date`, `is_del`, `update_by`)
VALUES (1, 'Võ Nhật Phi', 'MALE', '2001-04-17', '+84947679570', NULL,
        '$2a$10$Qwl/CsI69E42Hz3y.AVoGuq8CDWOtl/ulo6yZPU5Kkkzb68NUDYF2', 1, '2023-02-20 21:27:28', '2023-02-20 21:27:28',
        NULL, 0, 'system');
