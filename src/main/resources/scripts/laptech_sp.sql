...
BEGIN
    ...
    where path = in_path
      and type = in_type
      and title = in_title
      and link_product = in_link_product
      and used_date = in_used_date
      and ended_date = in_ended_date;
END;
...
BEGIN
    ...
    where name = in_name
      and country = in_country
      and establish_date = in_establish_date
      and logo = in_logo;
END;
...
BEGIN
    select *
    from tbl_comment
    where root_comment_id = in_root_comment_id
      and product_id = in_product_id
      and username = in_username
      and phone = in_phone
      and content = in_content;
END;
...
BEGIN
    ...
    where code = in_code
      and rate = in_rate
      and applied_type = in_applied_type
      and max_amount = in_max_amount
      and applied_date = in_applied_date
      and ended_date = in_ended_date;
END;
...
BEGIN
    ...
    where content = in_content
      and rating_point = in_rating_point
      and product_id = in_product_id
      and user_id = in_user_id;
END;
...
BEGIN
    ...
    where product_id = in_product_id
      and quantity = in_quantity
      and imported_date = in_imported_price
      and imported_price = in_imported_date;
END;
...
BEGIN
    ...
    where user_id = in_user_id
      ...
      and phone = in_phone
      and payment_amount = in_payment_amount
      and ship_cost = in_ship_cost
      and discount_amount = in_discount_amount
      and tax = in_tax
      and payment_total = in_payment_total
      and payment_type = in_payment_type
      and is_paid = in_is_paid
      and order_status = in_order_status
      and note = in_note;
END;
...
BEGIN
    ...
    where brand_id = in_brand_id
      ...
      and name = in_name
      and released_date = in_released_date
      and quantity_in_stock = in_quantity_in_stock
      and listed_price = in_listed_price;
END;
...
BEGIN
    ...
    where product_id = in_product_id
      and feedback_id = in_feedback_id
      and url = in_url
      and type = in_type;
END;
...
BEGIN
    ...
    where cart_id = in_cart_id
      ...
      and quantity = in_quantity
      and price = in_price
      and discount_price = in_discount_price;
END;
...
BEGIN
    select *
    from tbl_product
    where id in (select accessory_id from tbl_product_accessory where product_id = in_product_id);
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewAddress(IN in_id varchar(25), IN in_user_id bigint,
                                                                  ...
                                                                  IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_address (id, user_id, country, line1, line2, line3, street, is_default, update_by)
    VALUES (in_id, in_user_id, in_country, in_line1, in_line2, in_line3, in_street, in_is_default, in_update_by);
...
BEGIN
    INSERT INTO tbl_banner (path, type, title, link_product, used_date, ended_date, update_by)
    VALUES (in_path, in_type, in_title, in_link_product, in_used_date, in_ended_date, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewBrand(IN in_name varchar(100), IN in_country varchar(100),
                                                                ...
                                                                IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_brand (name, country, establish_date, logo, update_by)
    VALUES (in_name, in_country, in_establish_date, in_logo, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
BEGIN
    INSERT INTO tbl_cart (id, user_id, discount_id, update_by) VALUES (in_id, in_user_id, in_discount_id, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewCategory(IN in_name varchar(50), IN in_image varchar(255),
                                                                   ...
                                                                   IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_category (name, image, description, update_by)
    VALUES (in_name, in_image, in_description, in_update_by); SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewComment(IN in_id varchar(25),
                                                                  ...
                                                                  IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_comment (id, root_comment_id, product_id, username, phone, content, update_by)
    VALUES (in_id, in_root_comment_id, in_product_id, in_username, in_phone, in_content, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewDiscount(IN in_code varchar(20), IN in_rate float,
                                                                   ...
                                                                   IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_discount (code, rate, max_amount, applied_type, applied_date, ended_date, update_by)
    VALUES (in_code, in_rate, in_max_amount, in_applied_type, in_applied_date, in_ended_date, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
BEGIN
    INSERT INTO tbl_feedback (id, product_id, user_id, content, rating_point, update_by)
    VALUES (in_id, in_product_id, in_user_id, in_content, in_rating_point, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewImport(IN in_id varchar(25), IN in_product_id varchar(50),
                                                                 ...
                                                                 IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_import (id, product_id, quantity, imported_price, imported_date, update_by)
    VALUES (in_id, in_product_id, in_quantity, in_imported_price, in_imported_date, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
BEGIN
    INSERT INTO tbl_invoice (id, user_id, address, phone, payment_amount, ship_cost, discount_amount, tax,
                             payment_total, payment_type, is_paid, order_status, note, update_by)
    VALUES (in_id, in_user_id, in_address, in_phone, in_payment_amount, in_ship_cost, in_discount_amount, in_tax,
            in_payment_total, in_payment_type, in_is_paid, in_order_status, in_note, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewLabel(IN in_name varchar(25), IN in_icon varchar(255),
                                                                ...
                                                                IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_label (name, icon, title, description, update_by)
    VALUES (in_name, in_icon, in_title, in_description, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewProduct(IN in_id varchar(50), IN in_brand_id bigint,
                                                                  ...
                                                                  IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_product (id, brand_id, category_id, name, released_date, quantity_in_stock, listed_price,
                             specifications, description_detail, update_by)
    VALUES (in_id, in_brand_id, in_category_id, in_name, in_released_date, in_quantity_in_stock, in_listed_price,
            in_specifications, in_description_detail, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewProductImage(IN in_id varchar(50),
                                                                       ...
                                                                       IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_product_image (id, product_id, feedback_id, url, type, update_by)
    VALUES (in_id, in_product_id, in_feedback_id, in_url, in_type, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewProductUnit(IN in_id varchar(25),
                                                                      ...
                                                                      IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_product_unit (id, product_id, cart_id, invoice_id, quantity, price, discount_price, update_by)
    VALUES (in_id, in_product_id, in_cart_id, in_invoice_id, in_quantity, in_price, in_discount_price, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
create
    definer = youtube2_fi@`%.%.%.%` procedure sp_InsertNewRole(IN in_name varchar(25), IN in_description varchar(100),
                                                               IN in_update_by varchar(100))
BEGIN
    INSERT INTO tbl_role (name, description, update_by) VALUES (in_name, in_description, in_update_by);
    SELECT LAST_INSERT_ID();
END;
...
BEGIN
    INSERT INTO tbl_product_accessory (product_id, accessory_id) VALUES (in_product_id, in_accessory_id);
    SELECT LAST_INSERT_ID();
END;
...
BEGIN
    INSERT INTO tbl_product_discount (product_id, discount_id) VALUES (in_product_id, in_discount_id);
    SELECT LAST_INSERT_ID();
END;
...
BEGIN
    ...
    SET path=in_path,
        type=in_type,
        title=in_title,
        link_product=in_link_product,
        used_date=in_used_date,
        ended_date=in_ended_date,
        update_by=in_update_by
    WHERE id = in_id;
END;
...
BEGIN
    ...
    SET name=in_name,
        country=in_country,
        establish_date=in_establish_date,
        logo=in_logo,
        update_by=in_update_by
    WHERE id = in_id;
END;
...
BEGIN
    UPDATE tbl_comment
    SET root_comment_id=in_root_comment_id,
...
BEGIN
    ...
    SET code=in_code,
        ...
        applied_type=in_applied_type,
        applied_date=in_applied_date,
        ended_date=in_ended_date,
        update_by=in_update_by
    WHERE id = in_id;
END;
...
BEGIN
    ...
    SET product_id=in_product_id,
        ...
        imported_price=in_imported_price,
        imported_date=in_imported_date,
        update_by=in_update_by
    WHERE id = in_id;
END;
...
BEGIN
    ...
    SET user_id=in_user_id,
        ...
        ship_cost=in_ship_cost,
        discount_amount=in_discount_amount,
        tax=in_tax,
        payment_total=in_payment_total,
...
BEGIN
    UPDATE tbl_product
    SET brand_id=in_brand_id,
        category_id=in_category_id,
        name=in_name,
        released_date=in_released_date,
        quantity_in_stock=in_quantity_in_stock,
        listed_price=in_listed_price,
        specifications=in_specifications,
        description_detail=in_description_detail,
        update_by=in_update_by
    WHERE id = in_id;
END;
