...
/**
 * @author khangdoan
 * This source code was get from another partner
 * Thanks for this, with all my respect
 */
...
public class Encoder {
    ...
    public static String encryptRSA(byte[] dataBytes, String publicKey) throws Exception {
        ...
        _publicKey = keyFactory.generatePublic(publicKeySpec);
    ...
    public static String decryptRSA(String encryptData, String privateKey) {
        try {
            ...
            log.error("[DecryptRSA] {}", ex.getLocalizedMessage());
            return "";
        }
    }
}
